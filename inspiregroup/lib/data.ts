...
export const departmentData: DepartmentData[] = [
  ...
  },
  {
    ...
    color: "#f97316",
    rgb: "249,115,22",
    desc: "Revenue generation, client acquisition, account management, and pipeline growth.",
    tags: ["Revenue", "Client Relations", "Pipeline", "Accounts"],
    videos: [
      { title: "Sales Process Walkthrough", desc: "End-to-end guide from lead to closed deal.", duration: "10:45" },
      { title: "CRM System Tutorial", desc: "How to log activities and manage your pipeline.", duration: "8:20" },
      { title: "Pitch & Presentation Tips", desc: "Best practices for client-facing presentations.", duration: "7:55" },
    ],
    docs: [
      { title: "Sales Playbook 2026", desc: "Strategies, scripts, and objection handling guides.", size: "2.9 MB", type: "PDF", icon: "ph-duotone ph-file-pdf" },
      { title: "Pricing & Quotation Guide", desc: "Approved pricing tiers and quotation templates.", size: "1.4 MB", type: "PDF", icon: "ph-duotone ph-file-pdf" },
      { title: "Q2 Target Sheet", desc: "Department sales targets and KPI tracking.", size: "0.8 MB", type: "XLSX", icon: "ph-duotone ph-file-xls" },
    ],
    team: [
      { name: "Ryan Mercado", role: "Sales Director", initials: "RM", head: true },
      { name: "Jess Navarro", role: "Senior Account Executive", initials: "JN" },
      { name: "Carla Diaz", role: "Sales Coordinator", initials: "CD" },
      { name: "Ben Uy", role: "Business Development Officer", initials: "BU" },
    ],
  },
  {
    id: "it",
  ...
  {
    id: "itech",
    name: "Itech Department",
    icon: "ph-duotone ph-cpu",
    color: "#e11d48",
    rgb: "225,29,72",
    desc: "Technology products, hardware solutions, and technical services.",
    tags: ["Hardware", "Tech Products", "Services", "Solutions"],
    videos: [
      { title: "Itech Product Line Overview", desc: "Complete catalog of Itech hardware and tech offerings.", duration: "10:15" },
      { title: "Technical Support SOP", desc: "Standard procedures for handling technical service requests.", duration: "8:30" },
      { title: "Product Demo Guide", desc: "How to conduct effective product demonstrations.", duration: "7:10" },
    ],
    docs: [
      { title: "Product Catalog 2026", desc: "Full catalog of Itech products and specifications.", size: "5.4 MB", type: "PDF", icon: "ph-duotone ph-file-pdf" },
      { title: "Technical Service Manual", desc: "Installation and maintenance guides for all products.", size: "3.8 MB", type: "PDF", icon: "ph-duotone ph-file-pdf" },
      { title: "Warranty & Returns Policy", desc: "Policies for product warranties and returns.", size: "0.7 MB", type: "PDF", icon: "ph-duotone ph-file-pdf" },
    ],
    team: [
      { name: "Victor Ong", role: "Itech Department Head", initials: "VO", head: true },
      { name: "Leo Tan", role: "Product Specialist", initials: "LT" },
      { name: "Rachel Yu", role: "Technical Support Engineer", initials: "RY" },
      { name: "Mark Dela Cruz", role: "Sales & Solutions Officer", initials: "MD" },
    ],
  },
  {
    id: "utility",
