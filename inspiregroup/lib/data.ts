...
export const departmentData: DepartmentData[] = [
  ...
  },
  {
    ...
    docs: [],
    team: [
      { name: "Gerlie Fabian De Asis", role: "Head", initials: "GF", head: true, image: "/images/departments/admin/gerlie.jpg" },
      { name: "Kristel Gabriel", role: "Internal Audit", initials: "KG", image: "/images/departments/admin/kristel.webp" },
      { name: "Roxanne Rebadavia", role: "Receptionist I", initials: "RR", image: "/images/departments/admin/roxanne.jpg" },
      { name: "Ericka Mae Vejiga", role: "Receptionist II", initials: "EV", image: "/images/departments/admin/ericka.jpg" },
      { name: "Nathaniel Mustacho", role: "Security", initials: "NM", image: "/images/departments/admin/nathaniel.jpg" },
      { name: "Rosalinda Gravador", role: "Member", initials: "RG", image: "/images/departments/admin/rosalinda.jpg" },
      { name: "Zylela Gojar", role: "Member", initials: "ZG", image: "/images/departments/admin/zylela.jpg" },
      { name: "Prince Kevin Mark Velasquez", role: "Member", initials: "PV", image: "/images/departments/admin/prince.jpg" },
    ],
  },
  {
    id: "it",
